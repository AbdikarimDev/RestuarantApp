      ...
      <View>
        ...
        >
          ...
          <View className="flex flex-row gap-5 justify-between items-end   h-[300px] mb-auto  ">
            <View>
              <Text className="font-[500] text-[14px] text-[#000]  ">
                Total:
              </Text>
              <View className="flex flex-row gap-2 ">
                <Image
                  source={images.naira}
                  className="w-[12px] h-[16px] mt-2 "
                />
                <Text className="font-[700] text-[24px] text-[#000]  ">
                  60,000
                </Text>
              </View>
            </View>
            ...
            <Pressable
              ...
              className="bg-[#FFA451] w-[199px] h-[56px] rounded-[10px] flex justify-center items-center"
            >
        ...
        >
          ...
          <View className="bg-white absolute bottom-0 h-[406px] left-0 right-0 rounded-t-3xl p-6">
            ...
            <TextInput
              ...
              className="bg-[#F3F1F1] w-[376px] mb-6 h-[56px] rounded-[10px] "
            />
